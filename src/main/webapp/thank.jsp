...
<html><head><title>thank you</title>
    ...
    <body>
        ...
        <h1 style="style.css">Payment Successful!</h1>
        <h2 style="style.css">Thank you for placing order with Food Box.....<br>
        You order will be delivered to your address within 15 minutes...</h2>
