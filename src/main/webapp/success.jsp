    ...
    <body>
        ...
        <form method="post" action="order.jsp">
            <table class="w3-table" style="background-color:#F5F5F5"> 
                ...
                <tr>
                    <td><img class="rounded-circle" src="Images/pizzas/bigmess.png" height=240 width=290></td>
                    <td><img class="rounded-circle"src="Images/pizzas/proscuito.png" height=240 width=290></td>
                    <td><img class="rounded-circle"src="Images/pizzas/ml.png" height=240 width=290></td>
                </tr>
                ...
                <tr>
                    <td><img class="rounded-circle"src="Images/pizzas/break.png" height=240 width=290></td>
                    <td><img class="rounded-circle"src="Images/pizzas/bureger.png" height=240 width=290></td>
                    <td><img class="rounded-circle"src="Images/pizzas/cone.png" height=240 width=290></td>
                </tr>
                ...
                <tr>
                    <td><img class="rounded-circle"src="Images/pizzas/eggs.png" height=240 width=290></td>
                    <td><img class="rounded-circle"src="Images/pizzas/love.png" height=240 width=290></td>
                    <td><img class="rounded-circle"src="Images/pizzas/rucola.png" height=240 width=290></td>
                </tr>
     ...
     <div class="jumbotron text-center" style="margin-bottom:0">
        <p class="">Copyrights Deebika @ Simplilearn</p>
    </div>
 </footer>
        <%
            }
