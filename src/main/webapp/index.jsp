...
<html>
        ...
        <nav class="navbar navbar-expand-md navbar-dark" style="background-color: tomato">
         <div>
          ...
          <ul class="navbar-nav">
             ...
             <li><a href="chefs.jsp" class="nav-link">Our chefs</a></li>
   ...
   <br><br>
        ...
        <div >
            <div style="text-align:center">Excellent Customer Service at Your Doorstep<br><h4></h4></div>
        </div>
    <table  class="w3-table " style="background-color:#14FFFF">
        ...
        <tr>
            ...
            <td><img src="Images/bike.png"class="rounded-circle" style="width:100%" height=250 width=250></td>
